...
public class Complex {
     ...
     * This quantity is also known as the <em>modulus</em> or
     * <em>magnitude</em>.
     *
     ...
     */
    public Complex sin() {
        return new Complex(Math.sin(re) * Math.cosh(im), Math.cos(re) * Math
                .sinh(im));
    }
     ...
     */
    public Complex cos() {
        return new Complex(Math.cos(re) * Math.cosh(im), -Math.sin(re) * Math
                .sinh(im));
    }
