 ...
 * 0 to 0 ( 0.00)
 * 0 to 1 ( 0.93) 0->2 0.26 2->7 0.34 7->3 0.39 3->6 0.52 6->4 -1.25 4->5 0.35
 * 5->1 0.32
 ...
 * The constructor takes time proportional to <em>V</em> (<em>V</em> +
 * <em>E</em>)
...
public class BellmanFordSP {
     ...
     *         as an iterable of edges, and {@code null} if there is no such
     *         cycle
     */
