...
public class TwoPersonZeroSumGame {
    ...
    private boolean certifySolution(double[][] payoff) {
        return isPrimalFeasible() && isDualFeasible() && isNashEquilibrium(
                payoff);
    }
    ...
    private static void test2() {
        double[][] payoff = { { 0, 2, -3, 0 }, { -2, 0, 0, 3 }, { 3, 0, 0, -4 },
                { 0, -3, 4, 0 } };
    ...
    private static void test4() {
        double[][] payoff = { { 0, 2, -1, -1 }, { 0, 1, -2, -1 }, { -1, -1, 1,
                1 }, { -1, 0, 0, 1 }, { 1, -2, 0, -3 }, { 1, -1, -1, -3 }, { 0,
                        -3, 2, -1 }, { 0, -2, 1, -1 }, };
