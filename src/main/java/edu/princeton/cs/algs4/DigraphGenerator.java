...
public class DigraphGenerator {
     ...
     * edge between any two vertices with probability {@code p}. This is
     * sometimes
     ...
     * edges and (at least) {@code c} strong components. The vertices are
     * randomly
     * assigned integer labels between {@code 0} and {@code c-1} (corresponding
     * to
     * strong components). Then, a strong component is creates among the
     * vertices
