 ...
 * for the subarray, instead of doing in-place or reusing a single temporary
 * array.
 * 
 * <p>
...
public class FFT {
     ...
     * @throws IllegalArgumentException if the length of {@code x} is not a
     *                                  power of 2
     */
     ...
     * @throws IllegalArgumentException if the length of {@code x} does not
     *                                  equal
     *                                  the length of {@code y} or if the length
     *                                  is not a power of 2
     */
