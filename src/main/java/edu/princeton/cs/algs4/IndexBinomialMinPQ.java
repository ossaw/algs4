...
public class IndexBinomialMinPQ<Key> implements Iterable<Integer> {
     ...
     * Worst case is O(n)
     * 
     * @param N          number of keys in the priority queue, index from
     *                   {@code 0} to {@code N-1}
    ...
    public int minIndex() {
        ...
        while (current.sibling != null) {
            min = (greater(min.key, current.sibling.key)) ? current.sibling
                    : min;
     ...
     * @throws java.lang.IllegalArgumentException if the specified index is
     *         invalid
     * @throws java.lang.IllegalArgumentException if the index is not in the
     *         queue
     ...
     * @throws java.lang.IllegalArgumentException if the specified index is
     *         invalid
     * @throws java.lang.IllegalArgumentException if the index has no key
     *         associated with
     */
