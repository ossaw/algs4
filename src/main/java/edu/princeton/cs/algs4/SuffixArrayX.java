...
public class SuffixArrayX {
     ...
     * suffix.
     * That is, {@code text.substring(sa.index(i))} is the <em>i</em> smallest
     * suffix.
     * 
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; check && i < s.length(); i++) {
            if (suffix1.index(i) != suffix2.index(i)) {
                ...
                String ith = "\"" + s.substring(suffix1.index(i), Math.min(
                        suffix1.index(i) + 50, s.length())) + "\"";
                String jth = "\"" + s.substring(suffix2.index(i), Math.min(
                        suffix2.index(i) + 50, s.length())) + "\"";
                StdOut.println(ith);
                StdOut.println(jth);
                check = false;
            }
        ...
        for (int i = 0; i < s.length(); i++) {
            ...
            String ith = "\"" + s.substring(index, Math.min(index + 50, s
                    .length())) + "\"";
