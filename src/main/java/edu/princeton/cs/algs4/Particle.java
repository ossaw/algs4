...
public class Particle {
     ...
     * according
     * to the laws of elastic collision. Assumes that the particles are
     * colliding
     * at this instant.
     *
     * @param that the other particle
    ...
    public void bounceOff(Particle that) {
        ...
        double magnitude = 2 * this.mass * that.mass * dvdr / ((this.mass
                + that.mass) * dist);
     ...
     * Assumes that the particle is colliding with a vertical wall at this
     * instant.
     */
     ...
     * <em>v</em><sup>2</sup>,
     * where <em>m</em> is the mass of this particle and <em>v</em> is its
     * velocity.
     *
